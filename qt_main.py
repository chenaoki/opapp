...
class ParamWidget(QWidget):
  ...
  def saveParam(self):
        ...
        params['camera']['shrink']         = int(self.edit0.text())
        ...
        params['vmem']['smooth_xy_size']   = int(self.edit5_0.text())
        params['vmem']['smooth_t_size']    = int(self.edit5_1.text())
  ...
  def loadParam(self):
        ...
        self.edit0.setText(str(params['camera']['shrink']))
        ...
        self.edit5_0.setText(str(params['vmem']['smooth_xy_size']))
        self.edit5_1.setText(str(params['vmem']['smooth_t_size']))
  ...
  def __init__(self):
    ...
    self.edit5_0 = QLineEdit()
    self.edit5_1 = QLineEdit()
    ...
    layout = QHBoxLayout()
    label_ = QLabel(u'サイズ圧縮　　　　　　　')
    layout.addWidget(label_)
    layout.addWidget(self.edit0)
    cont_cam.addLayout(layout)
    ...
    layout = QHBoxLayout()
    label_ = QLabel(u'xy平滑化　　　　　　　')
    layout.addWidget(label_)
    layout.addWidget(self.edit5_0)    
    cont_vmem.addLayout(layout)
    
    layout = QHBoxLayout()
    label_ = QLabel(u't平滑化　　　　　　　')
    layout.addWidget(label_)
    layout.addWidget(self.edit5_1)    
    cont_vmem.addLayout(layout)
